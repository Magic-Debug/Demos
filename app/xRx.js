        ...
        BoundCallbackObservable.prototype._subscribe = function (subscriber) {
            ...
            if (!scheduler) {
                ...
                return scheduler.schedule(BoundCallbackObservable.dispatch, 0, {
                    source: this, subscriber: subscriber,
        ...
        BoundNodeCallbackObservable.prototype._subscribe = function (subscriber) {
            ...
            if (!scheduler) {
                ...
                return scheduler.schedule(dispatch, 0, {
                    source: this, subscriber: subscriber, context: this.context
                });
            }
        };
        ...
        if (!subject) {
            ...
            var handler = function handlerFn() {
                ...
                if (err) {
                    ...
                    if (result_2 === errorObject) {
                        self.add(scheduler.schedule(dispatchError$1, 0, {
                            err: errorObject.e, subject: subject
                        }));
                    }
                    else {
                        self.add(scheduler.schedule(dispatchNext$1, 0, {
                            value: result_2, subject: subject
                        }));
                    }
                }
                else {
        ...
        TestScheduler.prototype.expectObservable = function (observable, unsubscriptionMarbles) {
            ...
            this.schedule(function () {
                subscription = observable.subscribe(function (x) {
                    ...
                    actual.push({
                        frame: _this.frame, notification: Notification.createNext(value)
                    });
                }, function (err) {
                    actual.push({
                        frame: _this.frame, notification: Notification.createError(err)
                    });
                }, function () {
                    actual.push({
                        frame: _this.frame, notification: Notification.createComplete()
                    });
                });
            }, 0);
